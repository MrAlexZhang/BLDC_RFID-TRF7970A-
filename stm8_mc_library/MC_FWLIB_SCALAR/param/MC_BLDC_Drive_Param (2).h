...
#define FORCED_STATUP_STEPS 2 // Number of forced step without Z sampling
#define STARTUP_CURRENT_LIMITATION 1800 // (unit mA)
...
//Fmin
#define Freq_Min         ((u16)1500)        // Setting of min frequency in closed loop mode
