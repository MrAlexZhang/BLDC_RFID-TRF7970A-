...
u8 tag_data[8]={0};
//u8 first_tag_data[8]={0};
//u8 second_tag_data[8]={0};
u8 actual_tag_data[8]={0};
    ...
    {	
      ...
      for(u8 cnt2=0;cnt2<8;cnt2++)
      {
        ...
        else 
        {
          ...
          if(rfid_delay_protect.RFID_DELAY_PROTECT_FLAG == 1)
          {
            if(rfid_delay_protect.rfid_delay_done == TRUE)
            {
              for(u8 cnt4=0;cnt4<8;cnt4++)
